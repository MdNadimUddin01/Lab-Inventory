            ...
            <tr key={item.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div className="flex justify-end space-x-3  py-2 px-3 rounded-lg shadow-sm">
                  <button className="p-1.5 rounded-md bg-blue-50 hover:bg-blue-100 transition-colors duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-blue-300">
                    <Edit size={18} className="text-white" />
                  </button>
                  <button className="p-1.5 rounded-md bg-white hover:bg-red-50 border border-red-200 transition-colors duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-red-300">
                    <Trash2
                      size={18}
